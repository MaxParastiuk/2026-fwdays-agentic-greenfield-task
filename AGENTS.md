...
> This repo is a **multi-tool plugin** (Claude Code · Cursor),
> with `AGENTS.md` skill as the portable core. See
...
When building or editing UI, follow [`.agents/skills/frontend-design-system/SKILL.md`](.agents/skills/frontend-design-system/SKILL.md) before writing code. Read `DESIGN.md` as the authoritative design reference.
