...
Server-side Maker agent that generates plain-text cover letters from a CV and job
description via Vercel AI Gateway, with optional revision feedback from the Checker
(capability `02-maker-agent`).
