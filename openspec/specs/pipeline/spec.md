...
Server-side pipeline orchestration that wires Maker and Checker into a revision loop
until score ≥ 8.0 or three iterations complete, returning structured `PipelineResult`
(capability `04-pipeline`).
